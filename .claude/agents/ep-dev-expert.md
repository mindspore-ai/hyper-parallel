...
- `.claude/rules/distributed.md` — DTensor invariants, `is_partial()`, stream sync, memory lifecycle.
- `.claude/rules/platform.md` — cross-platform checklist, lazy import convention.
- `.claude/skills/code-review/review-checklist.md` — distributed review items.
- `.claude/agents/dtensor-dev-expert.md` — layout, redistribution, op dispatch.
- `.claude/agents/tensor-dev-expert.md` — `parallelize_module`, `ParallelStyle`, mesh context.
- `.claude/agents/fsdp-dev-expert.md` — FSDP parameter lifecycle, when EP composes with FSDP.
