...
# ============================================================================
"""Pipeline-parallel stage builders for ``Llama3Model`` (see ``model.py``).
...
def count_llama3_parameters(cfg: Llama3DemoConfig) -> int:
    """Return parameter count of an unsharded reference ``Llama3Model`` (for logging)."""
    return sum(p.numel() for p in Llama3Model(cfg).parameters())
