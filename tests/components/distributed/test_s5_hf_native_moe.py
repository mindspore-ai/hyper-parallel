...
from hyper_parallel.components.distributed.ep_utils import (
    MOE_ROUTER_ADAPTERS,
...
from hyper_parallel.components.distributed.sharding_config import CP, EP, TP
...
def test_topk_router_module_adapter(tiny_hf_batched_moe):
    ...
    from hyper_parallel.components.distributed.ep_utils import _topk_router_module
...
def test_sigmoid_group_router_adapter():
    ...
    from hyper_parallel.components.distributed.ep_utils import _sigmoid_group_router
