...
class TestHfNativeEpComputeFactory:
    """内置 EP 工厂（ep_compute.hf_native_ep_compute_fn）：mesh 家族上下文
    的使用 + 路由内嵌纪律。"""
