"""MindSpore forward_and_gradfn in-process cases (worker/impl module).

Not collected by pytest directly — thin wrappers live in ``test_backward.py``
so collecting sibling distributed launchers does not import mindspore.
"""
