...
def _rms_norm(x, weight):
    # non-mint: ms.mint.rms_norm not available
    return ops.RmsNorm()(x, weight)[0]


register(OpShardCase(
    name="rms_norm_ops_dp",
    fn=_rms_norm,
    inputs=[
