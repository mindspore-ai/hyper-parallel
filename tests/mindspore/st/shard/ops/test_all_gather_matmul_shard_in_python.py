...
IMPL_FILE = str(
    Path(__file__).resolve().parent / "all_gather_matmul_shard_in_python.py"
)
...
def test_agm_ms_group1():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_agm_tp_input_shard0_x2_replicate", 20100, 2, 2, 2),
        MindSporeCase(IMPL_FILE, "test_agm_tp_input_shard0_x2_shard1",    20101, 2, 2, 2),
        MindSporeCase(IMPL_FILE, "test_agm_trans_x2_true",                20102, 2, 2, 2),
        MindSporeCase(IMPL_FILE, "test_agm_gather_output_false",          20103, 2, 2, 2),
    ])
...
def test_agm_ms_group2():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_agm_dp_tp_input_shard0",  20104, 4, 4, 2),
        MindSporeCase(IMPL_FILE, "test_agm_k_sharded_mp2_tp2",   20105, 4, 4, 2),
    ])
...
def test_agm_ms_group3():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_agm_k_sharded_mp2_np2_tp2", 20106, 8, 8, 2),
    ])
