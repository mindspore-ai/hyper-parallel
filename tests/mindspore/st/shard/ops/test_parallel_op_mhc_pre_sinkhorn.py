...
IMPL_FILE = str(
    Path(__file__).resolve().parent / "_test_parallel_op_mhc_pre_sinkhorn.py"
)
...
def test_mhc_pre_sinkhorn_group1():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_mhc_pre_sinkhorn_bsnd_replicated", worker_num=2, local_worker_num=2, glog_v=2),
        MindSporeCase(IMPL_FILE, "test_mhc_pre_sinkhorn_bsnd_dp", worker_num=2, local_worker_num=2, glog_v=2),
    ])
...
def test_mhc_pre_sinkhorn_group2():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_mhc_pre_sinkhorn_bsnd_dp_cp_tp", worker_num=8, local_worker_num=8, glog_v=2),
    ])
