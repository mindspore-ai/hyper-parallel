...
class SumExtNet(nn.Cell):
    ...
    def construct(self, x: Any, dim: Any=None, keepdim: Any=False, dtype: Any=None) -> object:
        """Forward computation."""
...
class ReduceMaxNet(nn.Cell):
    ...
    def __init__(self, device_mesh=None, relu_strategy=None, keep_dims=False) -> None:
        """Initialize."""
        super().__init__()
    ...
    def construct(self, x: Any, axis: Any=()) -> Any:
...
_MAX_DIM_MESH_SHAPE = (2, 2)
_MAX_DIM_ALIAS = ("dp", "tp")
...
def test_max_dim_data_parallel_1():
    ...
    mesh = init_device_mesh(
        device_type="npu",
        mesh_shape=_MAX_DIM_MESH_SHAPE,
        mesh_dim_names=_MAX_DIM_ALIAS
    )
