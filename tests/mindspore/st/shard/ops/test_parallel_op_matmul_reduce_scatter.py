...
IMPL_FILE = str(
    Path(__file__).resolve().parent / "_test_parallel_op_matmul_reduce_scatter.py"
)
...
def test_mrs_ms_group1():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_mrs_tp_basic", worker_num=2, local_worker_num=2, glog_v=2),
        MindSporeCase(IMPL_FILE, "test_mrs_trans_x2_true", worker_num=2, local_worker_num=2, glog_v=2),
        MindSporeCase(IMPL_FILE, "test_mrs_large_m", worker_num=2, local_worker_num=2, glog_v=2),
    ])
...
def test_mrs_ms_group2():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_mrs_dp_tp_basic", worker_num=4, local_worker_num=4, glog_v=2),
    ])
...
def test_mrs_ms_group3():
    ...
    """
    parallel_run([
        MindSporeCase(IMPL_FILE, "test_mrs_mp2_np2_tp2", worker_num=8, local_worker_num=8, glog_v=2),
    ])
