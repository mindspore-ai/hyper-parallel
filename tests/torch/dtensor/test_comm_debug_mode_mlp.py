...
# ============================================================================
"""Pytest launchers for CommDebugMode MLP distributed tests (2 ranks, gloo).
...
Ports are auto-assigned by the framework to avoid conflicts.
...
from tests.common.parallel_case import parallel_run, TorchCase  # pylint: disable=C0413
...
def test_comm_debug_mode_wave_one():
    ...
    Description:
        ...
        2. test_comm_debug_mode_debug_string:
           Verify generate_comm_debug_tracing_table() returns non-empty content.
        ...
        4. test_comm_debug_mode_with_module_tracker:
           Verify noise_level=2 tracing table contains "Module" boundary annotations.
    Expectation: All 4 worker cases run successfully.
    """
    _run_group(
        ("test_comm_debug_mode_captures_collectives", None, 2),
        ("test_comm_debug_mode_debug_string", None, 2),
        ("test_comm_debug_mode_tracing_table", None, 2),
        ("test_comm_debug_mode_with_module_tracker", None, 2),
    )
...
def test_comm_debug_mode_wave_two():
    ...
    """
    _run_group(
        ("test_comm_debug_mode_restores_platform", None, 2),
        ("test_comm_debug_mode_multiple_forwards", None, 2),
        ("test_comm_debug_mode_parameter_and_sharding_info", None, 2),
        ("test_comm_debug_mode_log_to_file", None, 2),
    )
...
def test_comm_debug_mode_wave_three():
    ...
    """
    _run_group(
        ("test_comm_debug_mode_json_dump", None, 2),
    )
