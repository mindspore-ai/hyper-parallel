...
from hyper_parallel.platform.torch.symmetric_memory import lifecycle
...
def start_shmem_lifetime() -> None:
    ...
    # The public allocation API cannot report owners retained by a previous scenario.
...
def environment_identity() -> dict:
    ...
    vendor, adapter = get_multicore_paths("torch")
    ...
    shmem_root = root / "build/native/payload/hyper_parallel/core/symmetric_memory/lib"
