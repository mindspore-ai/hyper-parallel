...
IMPL_FILE = str(Path(__file__).resolve().parent / "_test_parallel_op_empty_like.py")
...
def test_parallel_op_empty_like_group1():
    ...
    """
    parallel_run([
        TorchCase(IMPL_FILE, "test_empty_like_data_parallel", num_proc=4),
        TorchCase(IMPL_FILE, "test_empty_like_model_parallel", num_proc=4),
    ])
