...
def test_distributed_mul_inplace_basic():
    ...
    '''
    master_port = 10359
    file_name = "parallel_op_mul_.py"
    case_name = "test_distributed_mul_inplace_basic"
...
def test_distributed_mul_inplace_broadcast():
    ...
    master_port = 10359
    file_name = "parallel_op_mul_.py"
    case_name = "test_distributed_mul_inplace_broadcast"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_mul_inplace_scalar():
    ...
    master_port = 10359
    file_name = "parallel_op_mul_.py"
    case_name = "test_distributed_mul_inplace_scalar"
    torchrun_case(file_name, case_name, master_port)
