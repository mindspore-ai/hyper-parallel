...
IMPL_FILE = str(Path(__file__).resolve().parent / "_test_parallel_op_multinomial.py")
...
def test_parallel_op_multinomial_group1():
    ...
    """
    parallel_run([
        TorchCase(IMPL_FILE, "test_multinomial_1d_replicated", num_proc=4),
        TorchCase(IMPL_FILE, "test_multinomial_2d_data_parallel", num_proc=4),
    ])
...
def test_parallel_op_multinomial_group2():
    ...
    """
    parallel_run([
        TorchCase(IMPL_FILE, "test_multinomial_2d_fully_replicated", num_proc=4),
    ])
