...
# ============================================================================
# NPU-only error test functions (no Gloo counterpart)
# ============================================================================
...
def test_distributed_embedding_cp_max_norm_error():
    ...
    standalone_input = to_device(torch.from_numpy(standalone_input_np), "npu")
    standalone_weight = to_device(torch.from_numpy(standalone_weight_np), "npu")
