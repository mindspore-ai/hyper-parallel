...
def test_distributed_tensor_split_by_sections_unsharded():
    ...
    case_name = "test_distributed_tensor_split_by_sections_unsharded"
...
def test_distributed_tensor_split_by_indices_unsharded():
    ...
    master_port = 10359
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_by_indices_unsharded"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_default_dim():
    ...
    master_port = 10359
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_default_dim"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_negative_dim():
    ...
    master_port = 10359
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_negative_dim"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_3d_sections():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_3d_sections"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_1d_tensor_indices():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_1d_tensor_indices"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_uneven_sections():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_uneven_sections"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_out_of_bounds_indices():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_out_of_bounds_indices"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_4d_multi_shard():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_4d_multi_shard"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_list_indices():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_list_indices"
    torchrun_case(file_name, case_name, master_port)
...
def test_distributed_tensor_split_replicated():
    ...
    master_port = 10360
    file_name = "parallel_op_tensor_split.py"
    case_name = "test_distributed_tensor_split_replicated"
    torchrun_case(file_name, case_name, master_port)
