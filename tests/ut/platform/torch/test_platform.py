...
class TestTorchPlatformCore(unittest.TestCase):
    ...
    def test_create_p2p_edge_groups_creates_local_edges_in_stable_order(self) -> None:
        """
        Feature: PyTorch per-edge pipeline P2P groups.
        ...
        with mock.patch.dict(
            ...
            local_groups = TorchPlatform.create_p2p_edge_groups(
                [0, 1, 2, 3],
                include_wrap=True,
            )
