...
class TestLightningIndexer(unittest.TestCase):
    ...
    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_expand_impl_tnd_no_cp_returns_callable_29(self, mock_mesh_plat):
        """
    ...
    @patch("hyper_parallel.core.shard.ops.parallel_lightning_indexer.platform")
    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_expand_impl_tnd_cp_returns_callable_31(self, mock_mesh_plat, mock_op_plat):
        """
