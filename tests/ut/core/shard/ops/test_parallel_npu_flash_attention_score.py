...
class TestParallelNpuFlashAttentionScore(unittest.TestCase):
    ...
    def test_flash_attention_bnsd_layout_8(self, mock_platform):
        ...
        assert output_layouts[0].to_dict()["tensor_map"] == (1, 0, -1, -1)
    ...
    def test_flash_attention_bsnd_layout_10(self, mock_platform):
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSND"])
        assert output_layouts[0].to_dict()["tensor_map"] == (1, -1, 0, -1)

    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_flash_attention_sparse_mode_0_14(self, mock_platform):
        """
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 0])
        assert output_layouts[0].to_dict()["tensor_map"] == (2, -1, -1)
    ...
    def test_flash_attention_sparse_mode_2_15(self, mock_platform):
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 2])
    ...
    def test_flash_attention_large_world_size_20(self, mock_platform):
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [32, "BSH"])
    ...
    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_flash_attention_tnd_sp_27(self, mock_platform):
        """
    ...
    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_flash_attention_softmax_layout_param_29(self, mock_platform):
        """
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 0, "NZ"])
        assert output_layouts[0].to_dict()["tensor_map"] == (1, -1, 0)

    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_flash_attention_softmax_layout_empty_30(self, mock_platform):
        """
        ...
        output_with = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 0, ""])
        output_without = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 0])

        assert output_with[0].to_dict()["tensor_map"] == output_without[0].to_dict()["tensor_map"]
    ...
    def test_flash_attention_sparse_mode_3_sp_34(self, mock_platform):
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 3])
        assert output_layouts[0].to_dict()["tensor_map"] == (-1, 0, -1)
    ...
    def test_flash_attention_sparse_mode_4_band_35(self, mock_platform):
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [16, "BSH", 4])
    ...
    @patch("hyper_parallel.core.dtensor.device_mesh.platform")
    def test_flash_attention_head_num_1_39(self, mock_platform):
        """
        ...
        output_layouts = op.infer_layout((q_layout, k_layout, v_layout), [1, "BSH"])
        assert output_layouts[0].to_dict()["tensor_map"] == (1, -1, 0)
