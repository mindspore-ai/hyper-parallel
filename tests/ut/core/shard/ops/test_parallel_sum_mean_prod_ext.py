...
class TestParallelSumMeanProdExt(unittest.TestCase):
    ...
    def _run_scenario(self, op_name, x_layout, expected_map, extra_args):
    ...
    def test_sum_ext_data_parallel_1(self, mock_platform):
        ...
        self._run_scenario("SumExt", x_layout, expected_map=(-1, -1), extra_args=[0, False])
        self._run_scenario("MeanExt", x_layout, expected_map=(-1, -1), extra_args=[0, False])
    ...
    def test_sum_ext_model_parallel_2(self, mock_platform):
        ...
        self._run_scenario("SumExt", x_layout, expected_map=(-1, -1, -1), extra_args=[2, True])
        self._run_scenario("MeanExt", x_layout, expected_map=(-1, -1, -1), extra_args=[2, True])
    ...
    def test_sum_ext_hybrid_parallel_3(self, mock_platform):
        ...
        self._run_scenario("SumExt", x_layout, expected_map=(2, 0), extra_args=[1, False])
        self._run_scenario("MeanExt", x_layout, expected_map=(2, 0), extra_args=[1, False])
    ...
    def test_sum_ext_reduce_multiple_dims_4(self, mock_platform):
        ...
        self._run_scenario("SumExt", x_layout, expected_map=(-1, 1, -1), extra_args=[(0, 2), True])
        self._run_scenario("MeanExt", x_layout, expected_map=(-1, 1, -1), extra_args=[(0, 2), True])
    ...
    def test_sum_ext_reduce_all_dims_5(self, mock_platform):
        ...
        self._run_scenario("SumExt", x_layout, expected_map=(), extra_args=[None, False])
        self._run_scenario("MeanExt", x_layout, expected_map=(), extra_args=[None, False])
