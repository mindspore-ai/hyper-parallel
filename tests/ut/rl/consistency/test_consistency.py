...
def test_consistency_gate_accepts_right_padded_bit_exact_logprobs(
    ...
    monkeypatch.setattr(gates_module.dist, "all_gather_object", all_gather)
    monkeypatch.setattr(gates_module.dist, "get_rank", lambda: 0)
...
def test_consistency_post_update_diagnostic_counts_changed_action_tokens(
    ...
    monkeypatch.setattr(gates_module.dist, "all_gather_object", gather)
