...
from hyper_models._transformers.infrastructure import (
    ...
    _tie_model_weights_before_sharding,
)
...
def test_tied_weights_share_parameter_identity_before_sharding():
    """HF aliases are restored before FSDP records shared parameter owners."""
    class TiedModel(nn.Module):
        ...
        def tie_weights(self):
            """Tie output projection storage to token embeddings."""
