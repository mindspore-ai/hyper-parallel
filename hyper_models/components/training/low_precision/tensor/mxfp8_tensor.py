...
class MXFP8TensorData(QuantizedTensorData):
    ...
    def __init__(
        ...
        *,
        ...
        if row_data is None and col_data is None:
            raise ValueError(
                "MXFP8TensorData requires a row-wise or column-wise "
                "representation."
            )
...
class MXFP8Tensor(MXFP8TensorData, QuantizedTensor):
