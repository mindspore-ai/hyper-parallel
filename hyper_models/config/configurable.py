...
# ============================================================================
"""Declarative configuration base types for the HyperModels suite."""
...
class Configurable:
    ...
    class Config:
        ...
        def replace(self, **kwargs: object) -> "Configurable.Config":
        ...
        def build(self, **kwargs: object) -> "Configurable":
