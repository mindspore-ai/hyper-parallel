...
# ============================================================================
"""Qwen3 dense tensor-parallel parameter policies."""

from typing import Any


def build_parameter_sharding_rules() -> list[tuple[str, Any]]:
    """Return TP roles for parameters introduced by fused SwiGLU."""
