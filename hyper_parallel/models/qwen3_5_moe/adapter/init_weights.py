...
# ============================================================================
"""Shard-aware weight initialization for Qwen3.5-MoE models."""
...
def initialize_weights(model: nn.Module) -> None:
    """Initialize Qwen3.5-MoE weights with shard-aware gated-delta state.

    Args:
        model: Materialized Qwen3.5-MoE model whose parameters are already sharded.
    """
    for module in model.modules():
        if not isinstance(module, Qwen3_5MoeGatedDeltaNet):
            continue
