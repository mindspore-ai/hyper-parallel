...
# ============================================================================
"""HF VL-MoE checkpoint loader for hyper native models."""

from __future__ import annotations

__all__ = ["load_hf_vl_moe_state_dict"]
...
def load_hf_vl_moe_state_dict(
    ...
    """Load an VL-MoE safetensors dir into hyper key space."""
    ...
    logger.info(
        "Loading VL-MoE safetensors from %s (%d keys across %d shards), "
    ...
    logger.info(
        "HF VL-MoE -> hyper state_dict ready: %d keys (%d skipped)",
