...
class _BaseHyperAutoModelClass:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        build_options = {
            ...
            "validate_placement": kwargs.pop("validate_placement", False),
            "qat_config": kwargs.pop("qat_config", None),
            "fp8_config": kwargs.pop("fp8_config", None),
            "compile_config": kwargs.pop("compile_config", None),
            "freeze_config": kwargs.pop("freeze_config", None),
            "activation_checkpoint": kwargs.pop("activation_checkpoint", None),
            "swap_inputs": kwargs.pop("swap_inputs", False),
            "activation_swap": kwargs.pop("activation_swap", "none"),
            "model_init_dtype": kwargs.pop("model_init_dtype", None),
        }
        ...
        return cls._build_model(
            pretrained_model_name_or_path,
            {
                ...
                "backend": build_options["backend"],
                "peft_config": build_options["peft_config"],
                "torch_dtype": torch_dtype,
                "attn_implementation": attn_implementation,
                "validate_placement": build_options["validate_placement"],
                "load_base_model": True,
                "distributed_setup": distributed_setup,
                "qat_config": build_options["qat_config"],
                "fp8_config": build_options["fp8_config"],
                "compile_config": build_options["compile_config"],
                "freeze_config": build_options["freeze_config"],
                "activation_checkpoint": build_options["activation_checkpoint"],
                "swap_inputs": build_options["swap_inputs"],
                "activation_swap": build_options["activation_swap"],
                "model_init_dtype": build_options["model_init_dtype"],
            },
            *model_args,
    ...
    def _build_model(
        ...
        **kwargs,
        ...
        """
        build_context, *model_args = model_args
        ...
        with init_ctx:
            _, model = _init_model(
                ...
                pretrained_model_name_or_path,
                hf_config,
                build_context["attn_implementation"],
                build_context["torch_dtype"],
                is_hf_model,
                *model_args,
        ...
        model = apply_model_infrastructure(
            model,
            mesh=build_context["mesh"],
            sharding_planner=build_context["sharding_planner"],
            fsdp2_manager=build_context["fsdp2_manager"],
            peft_config=build_context["peft_config"],
            qat_config=build_context["qat_config"],
            fp8_config=build_context["fp8_config"],
            freeze_config=build_context["freeze_config"],
            compile_config=build_context["compile_config"],
            is_meta_device=is_meta_device,
            is_hf_model=is_hf_model,
            device=_current_device(),
            load_base_model=build_context["load_base_model"],
            pretrained_path=pretrained_model_name_or_path,
            validate_placement=build_context["validate_placement"],
            distributed_setup=build_context["distributed_setup"],
            activation_checkpoint=build_context["activation_checkpoint"],
            swap_inputs=build_context["swap_inputs"],
            activation_swap=build_context["activation_swap"],
            model_init_dtype=build_context["model_init_dtype"],
        )
