...
Before running examples, add the SAPP-ND root directory to `PYTHONPATH`.
...
cd <SAPP-ND>
export PYTHONPATH=$(pwd):${PYTHONPATH}
python -m memory_estimation.estimate_v2 memory_estimation/test_cases/mixtral/default.yaml --verbose --plot
```
...
```text
python -m memory_estimation.estimate_v2 --help
