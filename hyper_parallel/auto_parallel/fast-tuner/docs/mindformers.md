...
<tr>
 <td rowspan="3"> mindformers</td>
 <td>mindformers_dir</td>
 <td>run_mindformers.py路径，基于原生Mindspore搜索时需要填写该参数</td>
 <td>./mindformers</td>
</tr>
<tr>
 <td>yaml_path</td>
 <td>模型配置文件</td>
 <td>./config/pretrain.yaml</td>
</tr>
<tr>
 <td>dataset</td>
 <td>数据集路径</td>
 <td>./config/dataset/wiki103-4k.mindrecord</td>
</tr>
</table>
