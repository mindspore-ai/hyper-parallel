    ...
    *,
    ...
    for source_key in checkpoint_index.keys():
        ...
        if mapping_used:
            ...
            for renaming in renamings:
                ...
                if matched_pattern is not None:
                    used_transform_ids.add(id(renaming))
        ...
        if source_pattern is None:
            ...
            if mapping_used:
                used_transform_ids.add(id(converter))
    ...
    used_transforms = [
        transform for transform in weight_mapping if id(transform) in used_transform_ids
    ]
    return tuple(groups.values()), tuple(unexpected_keys), used_transforms
...
class CheckpointManager:
    ...
    def load_checkpoint(
        ...
        *,
        ...
        groups, unexpected_keys, used_conversions = _build_load_groups(
            self.model,
            checkpoint_index,
            targets,
    ...
    def _load_with_replacement_conversions(
        ...
        base_groups, unexpected_keys, used_base = _build_load_groups(
            source_model,
            checkpoint_index,
