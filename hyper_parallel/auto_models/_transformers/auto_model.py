...
from hyper_parallel.auto_models._transformers.registry import get_hf_config, get_is_hf_model
from hyper_parallel.auto_models.components.distributed.infrastructure import DistributedSetup
from hyper_parallel.auto_models.components.utils.device import get_device_id, get_device_type  # pylint: disable=syntax-error
...
class _BaseHyperAutoModelClass:
    ...
    def _build_model(
        ...
        **kwargs,
        ...
        # Step 1: Determine meta device
        from hyper_parallel.auto_models.components.distributed.init_utils import (  # pylint: disable=import-outside-toplevel
            get_world_size_safe,
        )
        is_meta_device = (
