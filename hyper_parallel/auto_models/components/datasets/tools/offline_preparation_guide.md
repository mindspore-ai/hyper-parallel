...
```bash
python -m hyper_parallel.auto_models.components.datasets.tools.offline_preparation [参数]
```
...
```bash
python -m hyper_parallel.auto_models.components.datasets.tools.huggingface_offline [参数]
```
...
from hyper_parallel.auto_models.components.datasets.tools.offline_preparation import prepare_offline_dataset
...
```bash
python -m hyper_parallel.auto_models.components.datasets.tools.offline_preparation --help
python -m hyper_parallel.auto_models.components.datasets.tools.huggingface_offline --help
```
