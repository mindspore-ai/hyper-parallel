...
def create_distributed_setup_from_config(cfg: Any) -> DistributedSetup:
    ...
    # A size-one FSDP domain still owns TP-Replicate gradient reduction.
    # Without it, pure TP leaves norm and RMSNorm gradients as rank-local
    # Partial contributions even though TP-sharded parameters train normally.
