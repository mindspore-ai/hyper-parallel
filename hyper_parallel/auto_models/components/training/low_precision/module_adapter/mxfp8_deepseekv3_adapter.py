...
# ============================================================================
"""DeepSeek-V3 packed-expert adapter backed by A5 MXFP8 grouped matmuls."""
...
from hyper_parallel.auto_models.components.model_transform.replacement import module_replacement
from hyper_parallel.auto_models.components.training.low_precision.functional import (
    npu_quant_grouped_linear,
)
from hyper_parallel.auto_models.components.training.low_precision.ops import (
    LowPrecisionCapabilityError,
    validate_npu_gmm_runtime,
)
from hyper_parallel.auto_models.components.training.low_precision.quantizers import (
    MXFP8Quantizer,
)
    ...
    *,
    ...
    if active_model_parallel_axes:
        raise NotImplementedError(
            "MXFP8 grouped experts currently require TP=CP=EP=PP=1; "
