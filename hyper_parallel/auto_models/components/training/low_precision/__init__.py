...
from hyper_parallel.auto_models.components.training.low_precision.module_adapter import (
...
from hyper_parallel.auto_models.components.training.low_precision.tensor import (
    HiFloat8Tensor,
