...
# The Liger-derived portions are licensed under the BSD 2-Clause license in
...
# pylint: disable=non-google-docstring
# Adapted from https://github.com/linkedin/Liger-Kernel/blob/main/src/liger_kernel/ops/backends/_ascend/ub_manager.py
