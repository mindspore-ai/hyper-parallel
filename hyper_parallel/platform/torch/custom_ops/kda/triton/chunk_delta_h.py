...
from .utils import exp2, input_guard, prepare_chunk_indices, prepare_chunk_offsets
...
@triton.jit(do_not_specialize=["T", "task_num", "num_core"])
def chunk_gated_delta_rule_bwd_kernel_dhu_blockdim64_npu(  # pylint: disable=too-many-nested-blocks
    q,
    k,
    w,
    g,
