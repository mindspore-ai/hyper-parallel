...
class Platform:
    ...
    @staticmethod
    def create_p2p_edge_groups(
            pp_rank_list: list[int],
            include_wrap: bool = False,
    ) -> dict[int, Any]:
        """Create per-edge P2P groups and return the groups adjacent to this rank.
        ...
        """
        raise NotImplementedError("Platform subclasses must implement create_p2p_edge_groups")
