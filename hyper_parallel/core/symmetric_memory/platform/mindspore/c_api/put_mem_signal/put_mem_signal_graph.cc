...
class OPS_API CustomPutMemSignalOpFuncImpl : public OpFuncImpl {
 public:
...
class CustomPutMemSignal : public KernelMod {
 public:
  CustomPutMemSignal() = default;
  ~CustomPutMemSignal() = default;
...
REG_GRAPH_MODE_OP(put_mem_signal, ms_custom_ops::CustomPutMemSignalOpFuncImpl, ms_custom_ops::CustomPutMemSignal);
