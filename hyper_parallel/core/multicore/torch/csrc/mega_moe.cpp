...
// ---------------------------------------------------------------------------
std::tuple<at::Tensor &, at::Tensor &, at::Tensor &, at::Tensor &, at::Tensor &> mega_moe_npu(
  ...
  static const hyper_parallel::multicore::CachedOpApi api("aclnnHyperMegaMoe", "aclnnHyperMegaMoeGetWorkspaceSize");
  hyper_parallel::multicore::execute_cached_op(
    api, dispatch_target, dispatch_target_off, dispatch_src, dispatch_src_off, dispatch_size, up_proj_weight,
    up_proj_glist, up_proj_y, swiglu_out, down_proj_weight, down_proj_glist, down_proj_y, combine_target,
    combine_target_off, combine_src_off, combine_size, gmm_workspace, up_proj_tiling, swiglu_tiling, down_proj_tiling,
    runtime_config, all_event_counters, profile_buffer, rank_id, ep, expert_num, hidden_size, seq_size);
...
// ---------------------------------------------------------------------------
std::tuple<at::Tensor &, at::Tensor &, at::Tensor &, at::Tensor &, at::Tensor &> mega_moe_meta(
  at::Tensor &dispatch_target, const at::Tensor & /*dispatch_target_off*/, const at::Tensor & /*dispatch_src*/,
  const at::Tensor & /*dispatch_src_off*/, const at::Tensor & /*dispatch_size*/, const at::Tensor & /*up_proj_weight*/,
  const at::Tensor & /*up_proj_glist*/, at::Tensor &up_proj_y, at::Tensor &swiglu_out,
  const at::Tensor & /*down_proj_weight*/, const at::Tensor & /*down_proj_glist*/, at::Tensor &down_proj_y,
  at::Tensor &combine_target, const at::Tensor & /*combine_target_off*/, const at::Tensor & /*combine_src_off*/,
  const at::Tensor & /*combine_size*/, const at::Tensor & /*gmm_workspace*/, const at::Tensor & /*up_proj_tiling*/,
  const at::Tensor & /*swiglu_tiling*/, const at::Tensor & /*down_proj_tiling*/, const at::Tensor & /*runtime_config*/,
  const at::Tensor & /*all_event_counters*/, const at::Tensor & /*profile_buffer*/, int64_t /*rank_id*/, int64_t /*ep*/,
...
// NPU (Ascend) device
TORCH_LIBRARY_IMPL(hyper_parallel, PrivateUse1, m) { m.impl("mega_moe", &mega_moe_npu); }

// Meta device (for shape tracing without actual compute)
TORCH_LIBRARY_IMPL(hyper_parallel, Meta, m) { m.impl("mega_moe", &mega_moe_meta); }
