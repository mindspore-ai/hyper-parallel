...
extern void get_mem(uint32_t block_dim, void *stream, uint64_t elementSize, uint8_t *target, uint8_t *target_offset,
...
int aclshmem_get_mem(uint32_t block_dim, aclrtStream stream, uint64_t elementSize, void *target, void *target_offset,
  ...
  int status = 0;
  // get_mem
  get_mem(block_dim, stream, elementSize, (uint8_t *)target, (uint8_t *)target_offset, (uint8_t *)src,
