...
Usage:
    python gen_runtime_data.py [--tp 4] [--ep 4] [--seq_size 8192]
                               ...
                               [--output_dir multicore_moe_ffn_tp4_ep4_910b]
...
from hyper_parallel.core.multicore.modules.moe_ffn.common.task_builders import add_terminate, add_dynamic_data
from .tiling_tables import (
    get_up_proj_tiling_bytes,
    get_down_proj_tiling_bytes,
    get_swiglu_tiling_bytes,
)
from .forward_graph import build_forward_graph
...
def parse_args():
    ...
    p.add_argument('--output_dir',        type=str,
                   default='multicore_moe_ffn_tp4_ep4_910b')
    return p.parse_args()
