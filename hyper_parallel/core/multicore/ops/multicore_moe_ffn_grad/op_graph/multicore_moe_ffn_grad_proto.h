...
/*!
 * \file multicore_moe_ffn_grad_proto.h
 * \brief
 */
#ifndef OPS_MATMUL_MULTICORE_MOE_FFN_GRAD_PROTO_H_
#define OPS_MATMUL_MULTICORE_MOE_FFN_GRAD_PROTO_H_

#include "graph/operator_reg.h"

namespace ge {
REG_OP(MulticoreMoeFfnGrad)
    ...
    .ATTR(seq_size, Int, 0)
    .OP_END_FACTORY_REG(MulticoreMoeFfnGrad)
} // namespace ge

#endif // OPS_MATMUL_MULTICORE_MOE_FFN_GRAD_PROTO_H_
