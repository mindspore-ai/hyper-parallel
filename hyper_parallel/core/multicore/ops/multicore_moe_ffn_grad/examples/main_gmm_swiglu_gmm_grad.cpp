...
int main() {
  ...
  // ++++++++++++++++++++++++++++++==========================================================================A1
  std::vector<int64_t> targetShape = {32768, 7168};
  std::vector<int64_t> targetOffsetShape = {16};
  std::vector<int64_t> srcShape = {32768, 7168};
  std::vector<int64_t> srcOffsetShape = {16};
  std::vector<int64_t> sizeShape = {16};
  ...
  taskSplitValue.alltoall_split_value = 4096 / 32;
  taskSplitValue.alltoall_task_num = 16 * 32;
  std::cout<<"zgp debug, main_gmm_swiglu_gmm here 0!"<<std::endl;

  // ++++++++++++++++++++++++++++++==========================================================================GMM1
  // "4096,7168;2048,7168"
  std::vector<std::vector<int64_t>> xShape = {{32768, 7168}};
  std::vector<std::vector<int64_t>> weightShape= {{8, 2048, 7168}};
  std::vector<std::vector<int64_t>> yShape = {{32768, 2048}};
  std::vector<int64_t> groupListShape = {{8}};
  std::vector<int64_t> groupListData = {4096, 8192, 12288, 16384, 20480, 24576, 28672, 32768};
  void* xDeviceAddr[1];
  ...
  taskSplitValue.gmm_task_num = 24 * 8;
  ...
  // ++++++++++++++++++++++++++++++==========================================================================swiglu_grad
  std::vector<int64_t> swigluXShape = {32768, 2048};
  std::vector<int64_t> swigluYShape = {32768, 4096};
  std::vector<int64_t> swigluOutShape = {32768, 4096};
  ...
  // ++++++++++++++++++++++++++++++==========================================================================GMM2
  // "4096,7168;2048,7168"
  std::vector<std::vector<int64_t>> xG2Shape = {{32768, 4096}};
  std::vector<std::vector<int64_t>> weightG2Shape= {{8, 7168, 4096}};
  std::vector<std::vector<int64_t>> yG2Shape = {{32768, 7168}};
  std::vector<int64_t> groupListG2Shape = {{8}};
  std::vector<int64_t> groupListG2Data = {4096, 8192, 12288, 16384, 20480, 24576, 28672, 32768};
  ...
  taskSplitValue.gmm_task_num_g2 = 24 * 8;
  ...
  // ++++++++++++++++++++++++++++++==========================================================================GMM3
  // "4096,7168;2048,7168"
  std::vector<std::vector<int64_t>> xG3Shape = {{32768, 7168}};
  std::vector<std::vector<int64_t>> weightG3Shape= {{32768, 4096}};
  std::vector<std::vector<int64_t>> yG3Shape = {{8, 7168, 4096}};
  std::vector<int64_t> groupListG3Shape = {{8}};
  std::vector<int64_t> groupListG3Data = {4096, 8192, 12288, 16384, 20480, 24576, 28672, 32768};
  ...
  taskSplitValue.gmm_task_num_g3 = 24 * 8;
  ...
  // ++++++++++++++++++++++++++++++==========================================================================GMM4
  // "4096,7168;2048,7168"
  std::vector<std::vector<int64_t>> xG4Shape = {{32768, 2048}};
  std::vector<std::vector<int64_t>> weightG4Shape= {{32768, 7168}};
  std::vector<std::vector<int64_t>> yG4Shape = {{8, 2048, 7168}};
  std::vector<int64_t> groupListG4Shape = {{8}};
  std::vector<int64_t> groupListG4Data = {4096, 8192, 12288, 16384, 20480, 24576, 28672, 32768};
  ...
  taskSplitValue.gmm_task_num_g4 = 24 * 8;
  ...
  // ++++++++++++++++++++++++++++++==========================================================================A2
  std::vector<int64_t> targetA2Shape = {32768, 7168};
  std::vector<int64_t> targetOffsetA2Shape = {16};
  std::vector<int64_t> srcA2Shape = {32768, 7168};
  std::vector<int64_t> srcOffsetA2Shape = {16};
  std::vector<int64_t> sizeA2Shape = {16};
  ...
  taskSplitValue.alltoall_task_num_a2 = 16 * 32;
  ...
  int64_t task_num_all = taskSplitValue.alltoall_task_num + taskSplitValue.gmm_task_num + taskSplitValue.swiglu_task_num + taskSplitValue.gmm_task_num_g2 + taskSplitValue.alltoall_task_num_a2;
  ...
  std::cout<<"zgp debug, main_gmm_swiglu_gmm here 7!"<<std::endl;
  ...
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(gmm_tiling_data_size), gmmTilingDeviceAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/gmm_tiling_data.bin");
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(gmm_g2_tiling_data_size), gmmG2TilingDeviceAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/gmmTilingG2.bin");
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(gmm_g3_tiling_data_size), gmmG3TilingDeviceAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/gmmTilingG3.bin");
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(gmm_g4_tiling_data_size), gmmG4TilingDeviceAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/gmmTilingG4.bin");
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(swiglu_tiling_data_size_), swigluTilingDeviceAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/swiglu_tiling.bin");
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(gmmWorkspaceSize), gmmWorkspaceDeviceAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/gmm_workspace.bin");
  // write_data_to_file_all<uint8_t>(static_cast<int64_t>(runtimeConfig_size), runtimeConfigAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/runtime_config_input_rank0.bin");
  write_data_to_file_all<uint8_t>(static_cast<int64_t>(runtimeConfig_size), runtimeConfigAddr, "../input_grad_32_24_task_reverse_alltoall_dynamic_reverse_gmm/runtime_config_input_rank1.bin");
