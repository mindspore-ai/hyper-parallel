 ...
 */
#include "aclnn_mega_moe_grad.h"

#include "aclnn_kernels/contiguous.h"
#include "aclnn_kernels/reshape.h"
#include "mega_moe_grad.h"
...
static void SetTransposedTensorListContiguous(MegaMoeGradParams &params, aclOpExecutor *executorPtr) {
...
ACLNN_API aclnnStatus aclnnMegaMoeGradGetWorkspaceSize(
  ...
  L2_DFX_PHASE_1(aclnnMegaMoeGrad,
  ...
  MegaMoeGradParams params{hidden, w1, permute_out, weight};
...
aclnnStatus aclnnMegaMoeGrad(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                     aclrtStream stream) {
  L2_DFX_PHASE_2(aclnnMegaMoeGrad);
