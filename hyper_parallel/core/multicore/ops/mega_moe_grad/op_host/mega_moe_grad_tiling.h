...
/**
 * @file mega_moe_grad_tiling.h
 */
#ifndef MEGA_MOE_GRAD_TILING_H
#define MEGA_MOE_GRAD_TILING_H
...
BEGIN_TILING_DATA_DEF(MegaMoeGradTilingData)
...
REGISTER_TILING_DATA_CLASS(MegaMoeGrad, MegaMoeGradTilingData)
}  // namespace optiling
#endif  // MEGA_MOE_GRAD_TILING_H
