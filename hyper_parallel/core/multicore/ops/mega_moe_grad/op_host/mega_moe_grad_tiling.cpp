 ...
 * @file mega_moe.cpp
 */
#include "mega_moe_grad_tiling.h"
...
#include "../op_kernel/mega_moe_grad_tiling_key.h"
...
struct MegaMoeGradCompileInfo {};

IMPL_OP_OPTILING(MegaMoeGrad)
  .Tiling(TilingFunc)
  .TilingParse<MegaMoeGradCompileInfo>(TilingPrepareTilingFunc);
