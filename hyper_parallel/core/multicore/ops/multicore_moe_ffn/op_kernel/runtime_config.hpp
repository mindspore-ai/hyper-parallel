...
#ifndef MULTICORE_MOE_FFN_RUNTIME_HEAD_TEST_KERNEL_CODE
#define MULTICORE_MOE_FFN_RUNTIME_HEAD_TEST_KERNEL_CODE
...
#endif  // MULTICORE_MOE_FFN_RUNTIME_HEAD_TEST_KERNEL_CODE
