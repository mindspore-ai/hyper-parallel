...
#include "multicore_moe_ffn_tiling.h"
#include "../op_kernel/multicore_moe_ffn_tiling_key.h"
...
static ge::graphStatus TilingFunc(gert::TilingContext *context) {
  ...
  MulticoreMoeFfnTilingData tiling;
...
struct MulticoreMoeFfnCompileInfo {};

IMPL_OP_OPTILING(MulticoreMoeFfn).Tiling(TilingFunc).TilingParse<MulticoreMoeFfnCompileInfo>(TilingPrepareTilingFunc);
