 ...
 */
#ifndef OP_API_INC_MULTICORE_MOE_FFN_
#define OP_API_INC_MULTICORE_MOE_FFN_
 ...
 */
ACLNN_API aclnnStatus aclnnMulticoreMoeFfnGetWorkspaceSize(
...
/**
 */
ACLNN_API aclnnStatus aclnnMulticoreMoeFfn(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                           aclrtStream stream);
...
#endif  // OP_API_INC_MULTICORE_MOE_FFN_
