...
# ============================================================================
"""HSDP scheduler"""
from hyper_parallel.core.hsdp_refactor.hsdp_utils import HSDPConfigV2, FSDPSchedulerState
from hyper_parallel.core.hsdp_refactor.hsdp_grad_hook import HSDPGradHook
from hyper_parallel.core.hsdp_refactor.hsdp_async_grad_hook import HSDPAsyncGradHook
...
class HSDPSchedulerV2:
    """HSDPScheduler is used to scheduler hsdp behavious, inspired by torch fully_shard"""
    ...
    def _hsdp_forward_hook(self, cell, inputs, outputs):
        ...
        if self.mp_policy.output_dtype is not None:
            ...
            outputs = _apply_to_tensors(
                functools.partial(_cast_fp_tensor, self.mp_policy.output_dtype),
                output,
            )
        return outputs
