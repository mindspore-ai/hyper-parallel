...
def _normalize_mhc_pre_cmhc_args(
    ...
    gamma is accepted by the experimental wrapper but ignored (kernel applies
    (void)gamma), so it is NOT included in the normalized positional args.
    """
    return (
