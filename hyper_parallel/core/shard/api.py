...
def parallelize_value_and_grad(*args, **kwargs):
    """Keep the legacy public API while the MindSpore value_and_grad shard path is removed."""
    raise NotImplementedError(
        "parallelize_value_and_grad was a MindSpore value_and_grad shard helper and is not available "
        "after the shard operator cleanup. Use Torch shard_module/custom_shard APIs instead."
    )
