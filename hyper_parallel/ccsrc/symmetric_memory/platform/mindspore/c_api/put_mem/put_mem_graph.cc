...
class OPS_API CustomPutMemOpFuncImpl : public OpFuncImpl {
 public:
...
class CustomPutMem : public KernelMod {
 public:
  CustomPutMem() = default;
  ~CustomPutMem() = default;
...
REG_GRAPH_MODE_OP(put_mem, ms_custom_ops::CustomPutMemOpFuncImpl, ms_custom_ops::CustomPutMem);
