...
class OPS_API CustomGetMemOpFuncImpl : public OpFuncImpl {
 public:
...
class CustomGetMem : public KernelMod {
 public:
  CustomGetMem() = default;
  ~CustomGetMem() = default;
...
REG_GRAPH_MODE_OP(get_mem, ms_custom_ops::CustomGetMemOpFuncImpl, ms_custom_ops::CustomGetMem);
