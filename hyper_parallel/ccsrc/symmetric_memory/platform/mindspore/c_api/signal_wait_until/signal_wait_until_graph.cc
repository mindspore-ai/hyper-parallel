...
class OPS_API CustomSignalWaitUntilOpFuncImpl : public OpFuncImpl {
 public:
...
class CustomSignalWaitUntil : public KernelMod {
 public:
  CustomSignalWaitUntil() = default;
  ~CustomSignalWaitUntil() = default;
...
REG_GRAPH_MODE_OP(signal_wait_until, ms_custom_ops::CustomSignalWaitUntilOpFuncImpl,
                  ms_custom_ops::CustomSignalWaitUntil);
