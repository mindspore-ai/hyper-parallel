...
#: ``create_tp_collective_lowerer``) is bound to the instance as ``_hp_tp``
...
#: (``self.ep_enable`` / ``self._hp_ep_group``), which
#: ``hp_bind_inline_state`` binds.
