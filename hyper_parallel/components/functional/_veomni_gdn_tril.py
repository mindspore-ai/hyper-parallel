...
"""VeOmni AscendC triangular inverse, retaining upstream kernel arithmetic.

Source: ByteDance-Seed/VeOmni, _ascend/triton/solve_tril.py.
Only utility imports are redirected; existing Hyper backend kernels are unchanged.
"""

import os
from typing import Optional

# Preserve upstream Triton signatures, including launch metadata unused by some kernels.
# pylint: disable=missing-public-type-hints,missing-public-docstring,unused-argument
# This optional implementation is PyTorch/NPU-specific.
import torch  # pylint: disable=forbidden-backend-import
import triton
import triton.language as tl

from hyper_parallel.components.functional._gdn_triton.utils import (
    prepare_chunk_indices, make_tensor_descriptor, input_guard,
)
...
def solve_tril_16x16_kernel(
    ...
    for tpp in tl.static_range(0, TPP):
        ...
        for i in range(2, min(16, T_eff - tile_row)):
            # Triton-Ascend exposes this extension dynamically.
            slice_res = tl.extract_slice(b_A_neg, [i, 0], [1, 16], [1, 1])  # pylint: disable=no-member
