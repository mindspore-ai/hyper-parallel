...
└── refactor/                       # 本特性工作区（本目录）
    ...
    │
    ├── guides/                     # 使用与走读
    │   ├── components_distributed_tutorial.md        # components/distributed 使用教程
...
| 上手 components/distributed | [guides/components_distributed_tutorial.md](guides/components_distributed_tutorial.md) |
