...
The workflow must load `.agent/rules/code-style.md` first and must not commit code that still violates it.
...
Invokes `autogit commit` with any provided arguments. See `.agent/skills/autogit/SKILL.md` for full workflow details.
