...
Before starting the review, always load `.agent/rules/code-style.md` and treat it as a mandatory review baseline.
...
python3 .agent/skills/autogit/scripts/autogit.py pylint-review --base upstream/master
```
...
*Code Quality, Thread Safety & Concurrency, and Performance sections in the review checklist are adapted from [PyTorch's PR review skill](https://github.com/pytorch/pytorch), with HyperParallel-specific distributed concurrency and cross-platform extensions.*
