...
General rules (async handle waits, `resize_(0)`, `param.grad = None`, buffer clearing) are in `.agent/rules/distributed.md` — **Stream Synchronization** and **Memory Management** sections.
...
- `.agent/rules/distributed.md`: stream sync, memory lifecycle, and distributed correctness rules.
- `.agent/skills/code-review/distributed-guidelines.md`: review heuristics for async communication, memory release, and distributed invariants.
- `.agent/skills/code-review/review-checklist.md`: final review checklist for correctness, tests, and cross-platform parity.
