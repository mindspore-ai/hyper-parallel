...
Always load `.agent/rules/code-style.md` before verification. Auto-fix mechanical
...
| ---- | ------- | ------- |
| code-style guard | `python3 .agent/skills/autogit/scripts/code_style_guard.py --fix <files>` | Apache header, trailing whitespace, public function typing/docstring |
...
| General/multiple | All unit tests | `python3 .agent/skills/autogit/scripts/autogit.py test` |
