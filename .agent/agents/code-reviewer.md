...
You must load `.agent/rules/code-style.md` before reviewing and treat its requirements as blocking review criteria.
...
- `.agent/skills/code-review/review-checklist.md` — Full checklist
- `.agent/skills/code-review/distributed-guidelines.md` — Stream sync and memory patterns
- `AGENTS.md` — Project conventions and key implementation notes
