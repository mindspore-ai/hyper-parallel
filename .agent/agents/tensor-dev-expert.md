...
- `.agent/rules/distributed.md` — stream sync, memory, DTensor safety.
- `.agent/skills/code-review/review-checklist.md` — conventions and distributed review items.
- `.agent/agents/dtensor-dev-expert.md` — layout, redistribution, op dispatch.
- `.agent/agents/pipeline-dev-expert.md` — when combining pipeline stages with parallel styles.
